...
req.ifUndef = function(variable, default_val) {
  if (variable === undefined) { return default_val; }
  else { return variable; }
};


req.ifUndeclared = function(variable, default_val) {
  try { variable.dummy; }
  catch(e) { var variable = default_val}
  return variable;
};
...
Call with isDeclared(variable), isDeclared(obj.prop), 
isDeclared(obj["propname"]),  isDeclared(obj.prop.prop), etc.
Works on principal that obj.noddefined won't throw error
but obj.noddefined.dummy will. */
req.isDeclared = function(identifier) {
  var ret = true;
