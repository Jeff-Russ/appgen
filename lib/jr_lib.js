...
// a way of adding a property/value to an object as a constant.
// the value (propvalue) can be a function definition. 
req.addConstProp = function(obj, propname_str, propvalue) {
  Object.defineProperty( obj, propname_str, {
    value: propvalue,
    writable: false,
    enumerable: true,
    configurable: true
 ...
 //___________________________ "Classes" __________________________________\\
//‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\\

req.Hash = function(data_obj) {
  ...
  if (data_obj instanceof Object) { copyObj(data_obj, this); }
  ...
  Object.defineProperties(this, {
    ...
    { value: function(prop, value, constant)
      { if (typeof(value) === 'object') { this[prop] = new Hash(value); return; }
    ...
    get:
    { value: function(prop)
      { if (prop === undefined) { return copyObj(this, {}); }
        else if (this.hasOwnProperty(prop)) {
          var type = typeof this[prop];
          if (type === 'object') {return copyObj(this[prop], {});}
          if (type !== 'function') {return this[prop];}
        }
      }
    },
    map:
    { value: function(func, opt)
      { for (var prop in this) {
          if (this.hasOwnProperty(prop)) { func.call(this, prop, opt); }
        }
      }
    },
    to_json:
    ...
    logJson:
    { value: function(prop)
      { if (prop === undefined) console.log(JSON.stringify(this));
        else console.log(JSON.stringify(this[prop]));
      }
    },
...
req.makeEnvOb = function (dirname){
  var envOb = {};

  clArgs = [process.argv.length - 2];
  for (var i = 2; i < process.argv.length; i++) {
    clArgs[i-1] = process.argv[i];
  }
  addConstProp(envOb, "ARGV", clArgs);
  addConstProp(envOb, "CALLER_DIR", process.cwd()); //works
  addConstProp(envOb, "CALLED_SCRIPT", process.argv[1]);
  addConstProp(envOb, "CALLED_SCRIPT_DIR", dirname);
  return envOb;
};
